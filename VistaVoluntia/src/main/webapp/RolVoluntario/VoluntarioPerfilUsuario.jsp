						...
						<div class="ml-4 flex items-center md:ml-6">
							...
							<div class="relative ml-3">
								...
								<div
									...
									<a href="../RolVoluntario/VoluntarioPerfilUsuario.jsp"
			...
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                    ...
                    hover:file:bg-violet-100" />
									...
									<!-- Campo oculto con la imagen actual (Base64) para enviarla si no se selecciona un nuevo archivo -->
