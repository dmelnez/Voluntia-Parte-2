			...
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="tituloServicio"
										...
										id="tituloServicio" placeholder="Titulo Servicio" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden" id="errorTitulo">Este
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="fechaInicioServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Fecha de Inicio </label> <input type="date" name="fechaInicioServicio"
										id="fechaInicioServicio" placeholder="Fecha Inicio" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorFechaInicio">Este campo es obligatorio.</p>
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="fechaFinServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Fecha de Fin </label> <input type="date" name="fechaFinServicio"
										id="fechaFinServicio" placeholder="Fecha Fin" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden" id="errorFechaFin">Este
										campo es obligatorio.</p>
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="categoriaServicio"
										...
										placeholder="Categoria Servicio"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="fechaLimiteInscripcionServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Fecha Limite Inscripcion </label> <input type="date"
										name="fechaLimiteInscripcionServicio"
										id="fechaLimiteInscripcionServicio" placeholder="Fecha Limite"
										required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorFechaLimiteInscripcion">Este campo es
										obligatorio.</p>
								</div>
							</div>
						</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="horaBaseServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Hora en Base </label> <input type="time" name="horaBaseServicio"
										id="horaBaseServicio" placeholder="Hora en Base" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden" id="errorHoraBase">Este
										campo es obligatorio.</p>
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="horaSalidaServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Hora Salida </label> <input type="time" name="horaSalidaServicio"
										id="horaSalidaServicio" placeholder="Hora Salida" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorHoraSalida">Este campo es obligatorio.</p>
								</div>
							</div>
						</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="maximoAsistentesServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Maximo Asistentes </label> <input type="number"
										name="maximoAsistentesServicio" id="maximoAsistentesServicio"
										placeholder="Maximo Asistentes"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="tipoServicio"
										...
										id="tipoServicio" placeholder="Tipo Servicio"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
								</div>
							</div>
						</div>
							...
							<div class="w-full">
								<div class="mb-5">
									<label for="descripcionServicio"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Descripcion del servicio </label> <input type="text"
					...
					<div id="loader"
						...
						<svg class="animate-spin h-10 w-10 text-white"
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    document.getElementById('errorTitulo').classList.add('hidden');
    document.getElementById('errorFechaInicio').classList.add('hidden');
    document.getElementById('errorFechaFin').classList.add('hidden');
    document.getElementById('errorFechaLimiteInscripcion').classList.add('hidden');
    document.getElementById('errorHoraBase').classList.add('hidden');
    document.getElementById('errorHoraSalida').classList.add('hidden');

    let valid = true;

    const tituloServicio = document.getElementById('tituloServicio');
    if (!tituloServicio.value) {
      valid = false;
      document.getElementById('errorTitulo').classList.remove('hidden');
    }

    const fechaInicioServicio = document.getElementById('fechaInicioServicio');
    if (!fechaInicioServicio.value) {
      valid = false;
      document.getElementById('errorFechaInicio').classList.remove('hidden');
    }

    const fechaFinServicio = document.getElementById('fechaFinServicio');
    if (!fechaFinServicio.value) {
      valid = false;
      document.getElementById('errorFechaFin').classList.remove('hidden');
    }

    const fechaLimiteInscripcionServicio = document.getElementById('fechaLimiteInscripcionServicio');
    if (!fechaLimiteInscripcionServicio.value) {
      valid = false;
      document.getElementById('errorFechaLimiteInscripcion').classList.remove('hidden');
    }

    const horaBaseServicio = document.getElementById('horaBaseServicio');
    if (!horaBaseServicio.value) {
      valid = false;
      document.getElementById('errorHoraBase').classList.remove('hidden');
    }

    const horaSalidaServicio = document.getElementById('horaSalidaServicio');
    if (!horaSalidaServicio.value) {
      valid = false;
      document.getElementById('errorHoraSalida').classList.remove('hidden');
    }
  ...
  function showNotification(status, message) {
    ...
    setTimeout(() => {
      container.remove();
      window.location.href = "/VistaVoluntia/RolAdministrador/AdminNuevoServicio.jsp"; // Redirige al finalizar la notificación
    }, 3000);
  }
});
</script>
