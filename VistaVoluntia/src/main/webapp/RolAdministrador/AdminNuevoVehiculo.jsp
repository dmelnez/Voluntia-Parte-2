				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
					...
					<form id="miFormulario" class="needs-validation" novalidate
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="marcaVehiculo"
										...
										Marca del Vehículo </label> <input type="text" name="marcaVehiculo"
										id="marcaVehiculo" placeholder="Marca Vehiculo"
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="modeloVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Modelo del Vehículo </label> <input type="text" name="modeloVehiculo"
										id="modeloVehiculo"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="fechaMatriculacionVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Fecha de Matriculación </label> <input type="date"
							...
							<div class="w-full">
								<div class="mb-5">
									<label for="tipoVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Tipo Vehículo </label> <input type="text" name="tipoVehiculo"
										id="tipoVehiculo" placeholder="Tipo Vehículo"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
								</div>
							</div>
						</div>
							...
							<div class="w-full">
								<div class="mb-5">
									<label for="proximaITVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Próxima ITV </label> <input type="date" name="proximaITVehiculo"
										id="proximaITVehiculo" required
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorProximaITV">Este campo es obligatorio.</p>
								</div>
							</div>
						</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="indicativoVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Indicativo Vehículo </label> <input type="text"
										name="indicativoVehiculo" id="indicativoVehiculo" required
										placeholder="Indicativo"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorIndicativo">Este campo es obligatorio.</p>
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="recursoVehiculo"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Recurso Vehículo </label> <input type="text" name="recursoVehiculo"
										id="recursoVehiculo" placeholder="Recurso Vehículo"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
								</div>
							</div>
						</div>
						...
						<div class="flex items-center space-x-6">
							...
							<label class="block"> <span class="sr-only">Elegir
									foto de perfil</span> <input type="file" onchange="loadFile(event)"
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showNotification(status, message) {
    ...
    setTimeout(() => {
      container.remove();
      window.location.href = "/VistaVoluntia/RolAdministrador/AdminNuevoVehiculo.jsp";
    }, 3000);
  }
});
</script>
