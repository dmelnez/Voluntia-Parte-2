			...
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
						...
						<form id="usuarioForm" class="needs-validation" novalidate
							...
							<div class="-mx-3 flex flex-wrap">
								<div class="w-full px-3 sm:w-1/2">
									...
									<input type="hidden" id="idUsuario" name="idUsuario"
										value="<%= request.getParameter("idUsuario") != null ? request.getParameter("idUsuario") : "" %>" />
									...
									<div class="mb-5">
										<label for="nombreUsuario"
											...
											value="<%= request.getParameter("nombreUsuario") %>"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="lName"
											...
											id="apellidosUsuario" placeholder="Apellidos"
											value="<%= request.getParameter("apellidosUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="time"
											...
											id="dniUsuario"
											value="<%= request.getParameter("dniUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
											placeholder="DNI / NIE" />
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fechaNacimientoUsuario"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Fecha de Nacimiento </label> <input type="text"
											id="fechaNacimientoUsuario"
											value="<%= request.getParameter("fechaNacimientoUsuario") %>"
											class="w-full rounded-md border border-gray-300 bg-gray-100 py-3 px-6 text-base font-medium text-gray-500 outline-none cursor-not-allowed"
											readonly />
									</div>
								...
								<div class="w-full ">
									<div class="mb-5">
										<label for="lName"
											...
											value="<%= request.getParameter("indicativoUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
							...
							<div class="flex items-center gap-4">
								<div class="w-1/2">
									<label for="generoUsuario"
										...
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
										required>
										<option value="<%= request.getParameter("generoUsuario") %>"
											disabled selected>Seleccionar Genero</option>
								...
								<div class="w-1/2">
									<label for="rolUsuario"
										...
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
										required>
										<option value="<%= request.getParameter("rolUsuario") %>"
											disabled selected>Privilegios</option>
							...
							<div class="mb-5">
								...
								<div class="flex items-center space-x-6">
									<div class="shrink-0">
										<img id="imagenPerfilPreview"
											class="h-16 w-16 object-cover rounded-full"
											src="${not empty usuario.imagenPerfilUsuario ? 'data:image/png;base64,' + usuario.imagenPerfilUsuario : 'https://static.vecteezy.com/system/resources/previews/026/530/210/non_2x/modern-person-icon-user-and-anonymous-icon-vector.jpg'}"
											alt="Imagen de perfil del usuario" />
									</div>
									<label class="block"> <span class="sr-only">Elige
											la foto de perfil</span> <input type="file"
										onchange="loadFile(event)" id="imagenPerfilUsuario"
                    ...
                    hover:file:bg-violet-100" />
									</label> <input type="hidden" id="imagenActual" name="imagenActual"
										value="${usuario.imagenPerfilUsuario}" />
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fName"
											...
											value="<%= request.getParameter("codigoPostalUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="lName"
											...
											value="<%= request.getParameter("localidadUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="telefonoUsuario"
											...
											value="<%= request.getParameter("telefonoUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="provinciaUsuario"
											...
											required>
											<option
												value="<%= request.getParameter("provinciaUsuario") %>"
								...
								<div class="w-full ">
									<div class="mb-5">
										<label for="lName"
											...
											value="<%= request.getParameter("direccionUsuario") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full">
									<div class="mb-5">
										<label for="correoUsuario"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Correo Electrónico </label> <input type="text" name="correoUsuario"
											id="correoUsuario" placeholder="Correo Electrónico"
											value="<%= request.getParameter("correoUsuario") %>"
							...
							<div class="mb-5 pt-3">
								<label
									class="mb-5 block text-base font-semibold text-[#07074D] sm:text-xl">
									Actualizar Contraseña (opcional) </label>
							</div>
							<div class="-mx-3 flex flex-wrap">
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="newPassword"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Nueva Contraseña </label> <input type="password" name="newPassword"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="confirmPassword"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Confirmar Nueva Contraseña </label> <input type="password"
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    .then(response => response.ok
      ? response.json().then(data => ({ status: 'success', message: data.mensaje || 'Modificado exitosamente' }))
      : response.json().then(data => ({ status: 'error',   message: data.mensaje || 'Error al modificar' }))
    )
    .then(result => {
  ...
  function showNotification(status, message) {
    ...
    let html = '';
    if (status === 'success') {
      html = `<div class="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md">
    ...
    setTimeout(() => {
      container.remove();
      window.location.href = "/VistaVoluntia/RolAdministrador/AdminModificarUsuario.jsp";
    }, 3000);
  }
});
</script>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('imagenActual').value = 
	...
	<script>
document.addEventListener("DOMContentLoaded", function () {
    const usuarioData = sessionStorage.getItem('usuarioModificar');
    ...
    if (usuarioData) {
        ...
        asignarValor("nombreUsuario", usuario.nombreUsuario);
        asignarValor("apellidosUsuario", usuario.apellidosUsuario);
        asignarValor("dniUsuario", usuario.dniUsuario);
        asignarValor("indicativoUsuario", usuario.indicativoUsuario);
        asignarValor("generoUsuario", usuario.generoUsuario);
        asignarValor("rolUsuario", usuario.rolUsuario);
        asignarValor("codigoPostalUsuario", usuario.codigoPostalUsuario);
        asignarValor("localidadUsuario", usuario.localidadUsuario);
        asignarValor("telefonoUsuario", usuario.telefonoUsuario);
        asignarValor("provinciaUsuario", usuario.provinciaUsuario);
        asignarValor("direccionUsuario", usuario.direccionUsuario);
        asignarValor("correoUsuario", usuario.correoUsuario);
        asignarValor("idUsuario", usuario.idUsuario);
        asignarValor("fechaNacimientoUsuario", usuario.fechaNacimientoUsuario);
        
        asignarValor("imagenActual", usuario.imagenPerfilUsuario);

        if (usuario.imagenPerfilUsuario) {
            const imagenPreview = document.getElementById('imagenPerfilPreview');
            if (imagenPreview) {

                imagenPreview.src = 'data:image/png;base64,' + usuario.imagenPerfilUsuario;
            }
        }
    }

    const fileInput = document.getElementById('imagenPerfilUsuario');
    if (fileInput) {
