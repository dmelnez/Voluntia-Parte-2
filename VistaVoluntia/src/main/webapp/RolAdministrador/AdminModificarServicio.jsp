				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
					<div class="mx-auto w-full max-w-[1000px] bg-white">
						<form class="needs-validation" novalidate
							action="/VistaVoluntia/servicio" method="post">
							<input type="hidden" name="accion" value="modificar" /> <input
								type="hidden" id="idServicio" name="idServicio"
								value="<%= request.getParameter("idServicio") != null ? request.getParameter("idServicio") : "" %>" />

							<div class="-mx-3 flex flex-wrap">
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="numeracionServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Numeración del Servicio </label> <input type="text"
											name="numeracionServicio" id="numeracionServicio"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="tituloServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Título del Servicio </label> <input type="text" name="tituloServicio"
											id="tituloServicio" placeholder="Título Servicio"
											value="<%= request.getParameter("tituloServicio") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
							...
							<div class="-mx-3 flex flex-wrap">
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fechaInicioServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Fecha de Inicio </label> <input type="text"
											name="fechaInicioServicio" id="fechaInicioServicio"
											value="<%= request.getParameter("fechaInicioServicio") %>"
											...
											readonly disabled placeholder="Fecha Inicio" />
									</div>
								</div>
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fechaFinServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Fecha de Fin </label> <input type="text" name="fechaFinServicio"
											id="fechaFinServicio"
											value="<%= request.getParameter("fechaFinServicio") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-gray-100 py-3 px-6 text-base font-medium text-[#6B7280] outline-none cursor-not-allowed"
											readonly disabled placeholder="Fecha Fin" />
									</div>
								</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="categoriaServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Categoría del Servicio </label> <input type="text"
											name="categoriaServicio" id="categoriaServicio"
											value="<%= request.getParameter("categoriaServicio") %>"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fechaLimiteInscripcionServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Fecha Límite Inscripción </label> <input type="text"
											name="fechaLimiteInscripcionServicio"
											id="fechaLimiteInscripcionServicio"
											value="<%= request.getParameter("fechaLimiteInscripcionServicio") %>"
											class="w-full rounded-md border border-[#e0e0e0] bg-gray-100 py-3 px-6 text-base font-medium text-[#6B7280] outline-none cursor-not-allowed"
											readonly disabled placeholder="Fecha Límite" />
									</div>
								</div>
							</div>
							...
							<div class="flex flex-wrap w-full">
								<div class="w-full">
									<div class="mb-5">
										<label for="horaBaseServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Hora en Base </label> <input type="text" name="horaBaseServicio"
											id="horaBaseServicio"
											value="<%= request.getParameter("horaBaseServicio") %>"
											placeholder="Hora Base" readonly disabled
											class="w-full rounded-md border border-[#e0e0e0] bg-gray-100 py-3 px-6 text-base font-medium text-[#6B7280] outline-none cursor-not-allowed" />
									</div>
								</div>
							</div>
							...
							<div class="flex flex-wrap w-full">
								<div class="w-full">
									<div class="mb-5">
										<label for="horaSalidaServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Hora Salida </label> <input type="text" name="horaSalidaServicio"
											id="horaSalidaServicio"
											value="<%= request.getParameter("horaSalidaServicio") %>"
											placeholder="Hora Salida" readonly disabled
											class="w-full rounded-md border border-[#e0e0e0] bg-gray-100 py-3 px-6 text-base font-medium text-[#6B7280] outline-none cursor-not-allowed" />
									</div>
								</div>
							</div>
							...
							<div class="-mx-3 flex flex-wrap">
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="maximoAsistentesServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Máximo Asistentes </label> <input type="number"
											name="maximoAsistentesServicio" id="maximoAsistentesServicio"
											value="<%= request.getParameter("maximoAsistentesServicio") %>"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="tipoServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Tipo de Servicio </label> <input type="text" name="tipoServicio"
											id="tipoServicio"
											value="<%= request.getParameter("tipoServicio") %>"
								...
								<div class="w-full">
									<div class="mb-5">
										<label for="descripcionServicio"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Descripción del Servicio </label> <input type="text"
											name="descripcionServicio" id="descripcionServicio"
											value="<%= request.getParameter("descripcionServicio") %>"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="idVehiculo"
											class="mb-3 block text-base font-medium text-[#07074D]">
											Asignar Vehículo </label> <select name="idVehiculo" id="idVehiculo"
...
$(document).ready(function () {
    $.ajax({
        url: 'http://localhost:8080/VistaVoluntia/vehiculo',
        method: 'GET',
        dataType: 'json',
        success: function (data) {
            console.log("Lista de vehículos:", data);
            var select = $('#idVehiculo');
            $.each(data, function (index, vehiculo) {
                select.append('<option value="' + vehiculo.idVehiculo + '">' + vehiculo.indicativoVehiculo + '</option>');
            });
        },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
	    var servicioData = sessionStorage.getItem('servicioModificar');

	    if (servicioData) {
	        var servicio = JSON.parse(servicioData);

	        document.getElementById("idServicio").value = servicio.idServicio;

	        document.getElementById("numeracionServicio").value = servicio.numeracionServicio;
	        document.getElementById("tituloServicio").value = servicio.tituloServicio ;
	        document.getElementById("fechaInicioServicio").value = servicio.fechaInicioServicio;
	        document.getElementById("fechaFinServicio").value = servicio.fechaFinServicio;
	        document.getElementById("fechaLimiteInscripcionServicio").value = servicio.fechaLimiteInscripcionServicio;
	        document.getElementById("horaBaseServicio").value = servicio.horaBaseServicio;
	        document.getElementById("horaSalidaServicio").value = servicio.horaSalidaServicio;
	        document.getElementById("fechaInicioServicio").setAttribute("readonly", true);
	        document.getElementById("fechaFinServicio").setAttribute("readonly", true);
	        document.getElementById("fechaLimiteInscripcionServicio").setAttribute("readonly", true);
	        document.getElementById("horaBaseServicio").setAttribute("readonly", true);
	        document.getElementById("horaSalidaServicio").setAttribute("readonly", true);


	        document.getElementById("maximoAsistentesServicio").value = servicio.maximoAsistentesServicio;
	        document.getElementById("tipoServicio").value = servicio.tipoServicio;
	        document.getElementById("categoriaServicio").value = servicio.categoriaServicio;
