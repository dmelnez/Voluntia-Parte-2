...
#dashboard-submenu {
	...
	<header class="bg-white shadow-sm">
		<div
			...
			<h1 class="text-3xl font-bold tracking-tight text-gray-900">Nueva
				Emergencia</h1>
			...
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
					...
					<form id="miFormulario" class="needs-validation" novalidate
						action="/VistaVoluntia/emergencia" method="post">
						<input type="hidden" name="accion" value="aniadir" />

						<div class="-mx-3 flex flex-wrap">
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="tituloEmergencia"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Título de la Emergencia </label> <input type="text"
										name="tituloEmergencia" id="tituloEmergencia"
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="categoriaEmergencia"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Categoría de la Emergencia </label> <input type="text"
										name="categoriaEmergencia" id="categoriaEmergencia"
						...
						<div class="-mx-3 flex flex-wrap">
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="descripcionEmergencia"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Descripción de la Emergencia </label> <input type="text"
										name="descripcionEmergencia" id="descripcionEmergencia"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="fechaLanzamientoEmergencia"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Fecha de Lanzamiento </label> <input type="date"
										name="fechaLanzamientoEmergencia"
										id="fechaLanzamientoEmergencia"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
										required />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorFechaLanzamiento">Este campo es obligatorio.</p>
								</div>
							</div>

							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="horaLanzamientoEmergencia"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Hora Lanzamiento </label> <input type="time"
										name="horaLanzamientoEmergencia"
										id="horaLanzamientoEmergencia"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
										required />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorHoraLanzamiento">Este campo es obligatorio.</p>
								</div>
							</div>
						</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mensaje) {
        ...
        setTimeout(() => {
            container.remove();
            if (status === 'success') {
                window.location.href = "<%= request.getContextPath() %>/RolAdministrador/AdminNuevaEmergencia.jsp";
            }
        }, 3000);
    }
});
  ...
  document.getElementById('miFormulario').addEventListener('submit', function(event) {
      ...
      document.getElementById('errorFechaLanzamiento').classList.add('hidden');
      document.getElementById('errorHoraLanzamiento').classList.add('hidden');

      const tituloEmergencia = document.getElementById('tituloEmergencia');
      if (!tituloEmergencia.value) {
          valid = false;
          document.getElementById('errorTitulo').classList.remove('hidden');
      }

      const fechaLanzamientoEmergencia = document.getElementById('fechaLanzamientoEmergencia');
      if (!fechaLanzamientoEmergencia.value) {
          valid = false;
          document.getElementById('errorFechaLanzamiento').classList.remove('hidden');
      }

      const horaLanzamientoEmergencia = document.getElementById('horaLanzamientoEmergencia');
      if (!horaLanzamientoEmergencia.value) {
          valid = false;
          document.getElementById('errorHoraLanzamiento').classList.remove('hidden');
      }
