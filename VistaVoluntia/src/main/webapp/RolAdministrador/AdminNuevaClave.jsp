							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="nombreClave"
										...
										Nombre Clave </label> <input type="text" name="nombreClave"
										id="nombreClave" placeholder="Nombre Clave"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorNombreClave">Este campo es obligatorio.</p>
								</div>
							</div>
							...
							<div class="w-full px-3 sm:w-1/2">
								<div class="mb-5">
									<label for="descripcionClave"
										class="mb-3 block text-base font-medium text-[#07074D]">
										Descripcion Clave </label> <input type="text" name="descripcionClave"
										id="descripcionClave" required placeholder="Descripcion Clave"
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									<p class="text-red-500 text-sm mt-1 hidden"
										id="errorDescripcionClave">Este campo es obligatorio.</p>
								</div>
							</div>
						</div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showNotification(status, message) {
    ...
    setTimeout(() => {
      container.remove();
      window.location.href = "/VistaVoluntia/RolAdministrador/AdminNuevaClave.jsp";
    }, 3000);
  }
});
</script>
