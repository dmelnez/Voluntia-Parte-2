			...
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				...
				<div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
								...
								<div class="w-full px-3 sm:w-1/2">
									...
									<div class="mb-5">
										<label for="nombreUsuario"
											...
											value="${sessionScope.nombreUsuario}"
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="lName"
											...
											value="${sessionScope.apellidosUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="time"
											...
											id="dniUsuario" value="${sessionScope.dniUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
											placeholder="DNI / NIE" />
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fechaNacimientoUsuario"
											...
											value="${sessionScope.fechaNacimientoUsuario}"
								...
								<div class="w-full ">
									<div class="mb-5">
										<label for="lName"
											...
											value="${sessionScope.indicativoUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
							...
							<div class="flex flex-wrap w-full">
								<div class="w-full ">
									<label for="generoUsuario"
										...
										class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
										required>
										<option value="${sessionScope.generoUsuario}" disabled
											selected>Seleccionar Genero</option>
								...
								<div class="flex items-center space-x-6">
									<div class="shrink-0">
										<img id="imagenPerfilPreview"
											...
											src="${not empty sessionScope.imagenPerfilUsuario ? 'data:image/png;base64,' + usuario.imagenPerfilUsuario : 'https://static.vecteezy.com/system/resources/previews/026/530/210/non_2x/modern-person-icon-user-and-anonymous-icon-vector.jpg'}"
											alt="Imagen de perfil del usuario" />
									</div>
                    ...
                    hover:file:bg-violet-100" />
										...
										value="${sessionScope.imagenPerfilUsuario}" />
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="fName"
											...
											value="${sessionScope.codigoPostalUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="lName"
											...
											value="${sessionScope.localidadUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="telefonoUsuario"
											...
											value="${sessionScope.telefonoUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
								<div class="w-full px-3 sm:w-1/2">
									<div class="mb-5">
										<label for="provinciaUsuario"
											...
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
											required>
											<option value="${sessionScope.provinciaUsuario}" disabled
												selected>Seleccione una provincia</option>
								...
								<div class="w-full ">
									<div class="mb-5">
										<label for="lName"
											...
											value="${sessionScope.direccionUsuario}"
											class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
									</div>
								</div>
							</div>
								...
								<div class="w-full">
									<div class="mb-5">
										<label for="correoUsuario"
											...
											value="${sessionScope.correoUsuario}"
							...
							<!-- NUEVA SECCIÓN: Actualizar Contraseña (opcional) justo después del correo -->
							<div class="mb-5 pt-3">
								<label
									class="mb-5 block text-base font-semibold text-[#07074D] sm:text-xl">
