        ...
        <div class="min-h-full">
            ...
            <header class="bg-white shadow-sm">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nueva Emergencia</h1>
                    <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="tituloEmergencia" id="tituloEmergencia"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="categoriaEmergencia"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Categoría de la Emergencia
                                                </label>
                                                <input type="text" name="categoriaEmergencia" id="categoriaEmergencia"
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="descripcionEmergencia"
                                                    id="descripcionEmergencia"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="fechaLanzamientoEmergencia"
                                                    id="fechaLanzamientoEmergencia"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                                    required />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorFechaLanzamiento">
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="time" name="horaLanzamientoEmergencia"
                                                    id="horaLanzamientoEmergencia"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                                    required />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorHoraLanzamiento">
                                                    Este campo es obligatorio.</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            `;
                                ...
                                setTimeout(() => {
                                    container.remove();
                                    if (status === 'success') {
                                        window.location.href = "<%= request.getContextPath() %>/RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp";
                                    }
                                }, 3000);
                            }
                        });
