						...
						<div class="mx-auto w-full max-w-[1000px] bg-white">
							<form class="needs-validation" novalidate
								...
								<input type="hidden" name="accion" value="modificar" /> <input
									type="hidden" id="idEmergencia" name="idEmergencia"
									value="<%= request.getParameter("idEmergencia") != null ? request.getParameter("idEmergencia") : "" %>" />
									...
									<div class="w-full px-3 sm:w-1/2">
										<div class="mb-5">
											<label for="tituloEmergencia"
												...
												value="<%= request.getParameter("tituloEmergencia") %>"
									...
									<div class="w-full px-3 sm:w-1/2">
										<div class="mb-5">
											<label for="categoriaEmergencia"
												...
												value="<%= request.getParameter("categoriaEmergencia") %>"
								...
								<div class="-mx-3 flex flex-wrap">
									<div class="w-full px-3 sm:w-1/2">
										<div class="mb-5">
											<label for="descripcionEmergencia"
												...
												value="<%= request.getParameter("descripcionEmergencia") %>"
									...
									<div class="w-full px-3 sm:w-1/2">
										<div class="mb-5">
											<label for="date"
												class="mb-3 block text-base font-medium text-[#07074D]">
												Fecha de Lanzamiento </label> <input type="text"
												value="<%= request.getParameter("fechaLanzamientoEmergencia") %>"
									...
									<div class="w-full px-3 sm:w-1/2">
										<div class="mb-5">
											<label for="horaLanzamientoEmergencia"
												class="mb-3 block text-base font-medium text-[#07074D]">
												Hora Lanzamiento </label> <input type="text"
												value="<%= request.getParameter("horaLanzamientoEmergencia") %>"
												name="horaLanzamientoEmergencia"
												id="horaLanzamientoEmergencia"
												placeholder="Categoria Servicio" disabled
												class="w-full rounded-md border border-[#e0e0e0] bg-gray-100 py-3 px-6 text-base font-medium text-[#6B7280] outline-none cursor-not-allowed"
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
	    var emergenciaData = sessionStorage.getItem('emergenciaModificar');

	    if (emergenciaData) {
	        var emergencia = JSON.parse(emergenciaData);

	        document.getElementById("idEmergencia").value = emergencia.idEmergencia;

	        
	        document.getElementById("tituloEmergencia").value = emergencia.tituloEmergencia;
	        document.getElementById("categoriaEmergencia").value = emergencia.categoriaEmergencia;
	        document.getElementById("descripcionEmergencia").value = emergencia.descripcionEmergencia;
	        document.getElementById("fechaLanzamientoEmergencia").value = emergencia.fechaLanzamientoEmergencia;
	        document.getElementById("horaLanzamientoEmergencia").value = emergencia.horaLanzamientoEmergencia;
	    }
	});
