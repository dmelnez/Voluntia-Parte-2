                ...
                <div class="min-h-full">
                    ...
                    <header class="bg-white shadow-sm">
                        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Modificar Usuario</h1>
                            <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                                ...
                                <x-placeholder>
                                    <div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
                                        <div class="mx-auto w-full max-w-[1000px] bg-white">
                                            ...
                                            <form class="needs-validation" novalidate action="/VistaVoluntia/usuario"
                                                ...
                                                <div class="-mx-3 flex flex-wrap">
                                                    <div class="w-full px-3 sm:w-1/2">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="dniUsuario" id="dniUsuario"
                                                                value="${sessionScope.dniUsuario}"
                                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                                                placeholder="DNI / NIE" />
                                                    ...
                                                    <div class="w-full px-3 sm:w-1/2">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" id="fechaNacimientoUsuario"
                                                ...
                                                <div class="flex flex-wrap w-full">
                                                    <div class="w-full ">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="indicativoUsuario"
                                                ...
                                                <div class="flex flex-wrap w-full">
                                                    <div class="w-full ">
                                                        <label for="generoUsuario"
                                                            class="block text-gray-700 font-medium mb-2">Género</label>
                                                ...
                                                <div class="-mx-3 flex flex-wrap">
                                                    <div class="w-full px-3 sm:w-1/2">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="codigoPostalUsuario"
                                                    ...
                                                    <div class="w-full px-3 sm:w-1/2">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="localidadUsuario"
                                                ...
                                                <div class="-mx-3 flex flex-wrap">
                                                    ...
                                                    <div class="w-full px-3 sm:w-1/2">
                                                        <div class="mb-5">
                                                            ...
                                                            <select id="provinciaUsuario" name="provinciaUsuario"
                                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                                                required>
                                                                <option value="${sessionScope.provinciaUsuario}"
                                                ...
                                                <div class="flex flex-wrap w-full">
                                                    <div class="w-full ">
                                                        <div class="mb-5">
                                                            ...
                                                            <input type="text" name="direccionUsuario"
