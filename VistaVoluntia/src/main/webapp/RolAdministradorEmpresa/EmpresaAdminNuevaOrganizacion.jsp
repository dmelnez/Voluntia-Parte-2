                ...
                <div class="min-h-full">
                                        ...
                                        <div class="relative ml-3">
                                            ...
                                            <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 ring-1 shadow-lg ring-black/5 focus:outline-hidden"
                                                ...
                                                <a href="#" class="block px-4 py-2 text-sm text-gray-700"
                                                    role="menuitem" tabindex="-1" id="user-menu-item-2">Cerrar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <header class="bg-white shadow-sm">
                        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nueva organizacion</h1>
                            <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                            ...
                            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                                <x-placeholder>
                                    <div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
                                        ...
                                        <form class="needs-validation" novalidate action="/VistaVoluntia/organizacion"
                                            method="post" enctype="multipart/form-data" id="organizacionForm">
                                                ...
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="nombreOrganizacion"
                                                            id="nombreOrganizacion" placeholder="Nombre Institución"
                                                            required
                                                ...
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="nifOrganizacion" id="nifOrganizacion"
                                                            ...
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="nifError">El NIF
                                                            es obligatorio</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="-mx-3 flex flex-wrap">
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="tel" name="telefonoOrganizacion"
                                                            id="telefonoOrganizacion" placeholder="Teléfono" required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="telefonoError">
                                                ...
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="email" name="emailOrganizacion"
                                                            id="emailOrganizacion" placeholder="correo@institucion.com"
                                                            required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="emailError">El
                                                            correo es obligatorio</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="-mx-3 flex flex-wrap">
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="ciudadOrganizacion"
                                                            id="ciudadOrganizacion" placeholder="Ciudad" required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="ciudadError">La
                                                            ciudad es obligatoria</p>
                                                    </div>
                                                </div>
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="provinciaOrganizacion"
                                                            id="provinciaOrganizacion" placeholder="Provincia" required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="provinciaError">
                                                            La provincia es obligatoria</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex flex-wrap w-full">
                                                <div class="w-full">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="direccionOrganizacion"
                                                            id="direccionOrganizacion" placeholder="Dirección" required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="direccionError">
                                                            La dirección es obligatoria</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="-mx-3 flex flex-wrap">
                                                <div class="w-full px-3 sm:w-1/2">
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" name="tipoInstitucionOrganizacion"
                                                            id="tipoInstitucionOrganizacion"
                                                            placeholder="Tipo de Institución" required
                                                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                        <p class="text-red-500 text-sm mt-2 hidden" id="tipoError">El
                                                            tipo de institución es obligatorio</p>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        form.addEventListener('submit', function (e) {
                            ...
                            let valid = true;
                            const nombre = document.getElementById('nombreOrganizacion');
                            const nif = document.getElementById('nifOrganizacion');
                            const telefono = document.getElementById('telefonoOrganizacion');
                            const email = document.getElementById('emailOrganizacion');
                            const ciudad = document.getElementById('ciudadOrganizacion');
                            const provincia = document.getElementById('provinciaOrganizacion');
                            const direccion = document.getElementById('direccionOrganizacion');
                            const tipoInst = document.getElementById('tipoInstitucionOrganizacion');
                            ...
                            [nombreError, nifError, telefonoError, emailError, ciudadError, provinciaError, direccionError, tipoError]
                            ...
                            if (nif.value.trim() === '') {
                                nifError.textContent = 'El NIF es obligatorio';
                            ...
                            if (tipoInst.value.trim() === '') {
                                tipoError.textContent = 'El tipo de institución es obligatorio';
                            ...
                            fetch(form.action, {
                                ...
                                .then(response => {
                                    ...
                                    if (response.ok) {
                                        showNotification('success', 'Organización guardada exitosamente');
                                    } else {
                                        showNotification('error', 'Error al guardar organización');
                                    }
                                })
                                .catch(() => {
                                    loader.classList.add('hidden');
           ...
           <div class="px-4 py-2 -mx-3">
             <div class="mx-3">
               ...
               <p class="text-sm text-gray-600">${message}</p>
                            ...
                            setTimeout(() => {
                                container.remove();
                                window.location.href = "/VistaVoluntia/RolAdministradorEmpresa/EmpresaAdminNuevaOrganizacion.jsp";
                            }, 3000);
                        }
                    });
                </script>
