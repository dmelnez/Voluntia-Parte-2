  ...
  <link rel="icon" type="image/x-icon" href="../Imagenes/favicon.ico">
    ...
    <body class="bg-gray-50 dark:bg-gray-900">
        ...
        <div class="min-h-full">
            ...
            <header class="bg-white shadow-sm">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nuevo Plan</h1>
                    <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                    ...
                    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <x-placeholder>
                            <div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
                                ...
                                <form id="planForm" class="needs-validation" novalidate action="/VistaVoluntia/plan"
                                    method="post">
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="tipoPlan" id="tipoPlan" placeholder="Tipo Plan"
                                                    required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-2 hidden" id="tipoPlanError">El tipo
                                                    de plan es obligatorio</p>
                                            </div>
                                        </div>

                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="precioPlan"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Precio Plan
                                                </label>
                                                <input type="number" name="precioPlan" id="precioPlan"
                                                    placeholder="Precio" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-2 hidden" id="precioPlanError">El
                                                    precio del plan es obligatorio</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="tiempoPlan"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Duración Plan
                                                </label>
                                                <input type="text" name="tiempoPlan" id="tiempoPlan"
                                                    placeholder="Duración Plan" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-2 hidden" id="tiempoPlanError">La
                                                    duración del plan es obligatoria</p>
                                            </div>
                                        </div>

                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="descripcionPlan"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Descripción Plan
                                                </label>
                                                <input type="text" name="descripcionPlan" id="descripcionPlan"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="numeroUsuariosPlan"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Número Usuarios
                                                </label>
                                                <input type="number" name="numeroUsuariosPlan" id="numeroUsuariosPlan"
                                                    placeholder="Número Usuarios" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-2 hidden"
                                                    id="numeroUsuariosPlanError">El número de usuarios es obligatorio
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            ...
                            form.addEventListener("submit", function (event) {
                                ...
                                document.getElementById("tipoPlanError").classList.add("hidden");
                                document.getElementById("precioPlanError").classList.add("hidden");
                                document.getElementById("tiempoPlanError").classList.add("hidden");
                                document.getElementById("numeroUsuariosPlanError").classList.add("hidden");

                                let valid = true;

                                const tipoPlan = document.getElementById("tipoPlan");
                                if (tipoPlan.value.trim() === "") {
                                    document.getElementById("tipoPlanError").textContent = "El tipo de plan es obligatorio";
                                    document.getElementById("tipoPlanError").classList.remove("hidden");
                                    valid = false;
                                }

                                const precioPlan = document.getElementById("precioPlan");
                                if (precioPlan.value.trim() === "") {
                                    document.getElementById("precioPlanError").textContent = "El precio del plan es obligatorio";
                                    document.getElementById("precioPlanError").classList.remove("hidden");
                                    valid = false;
                                }

                                const tiempoPlan = document.getElementById("tiempoPlan");
                                if (tiempoPlan.value.trim() === "") {
                                    document.getElementById("tiempoPlanError").textContent = "La duración del plan es obligatoria";
                                    document.getElementById("tiempoPlanError").classList.remove("hidden");
                                    valid = false;
                                }

                                const numeroUsuariosPlan = document.getElementById("numeroUsuariosPlan");
                                if (numeroUsuariosPlan.value.trim() === "") {
                                    document.getElementById("numeroUsuariosPlanError").textContent = "El número de usuarios es obligatorio";
                                    document.getElementById("numeroUsuariosPlanError").classList.remove("hidden");
                                    valid = false;
                                }
      ...
      `;
                                ...
                                setTimeout(() => {
                                    container.remove();
                                    window.location.href = "/VistaVoluntia/RolAdministradorEmpresa/EmpresaAdminNuevoPlan.jsp";
                                }, 3000);
                            }
                        });
                    </script>
