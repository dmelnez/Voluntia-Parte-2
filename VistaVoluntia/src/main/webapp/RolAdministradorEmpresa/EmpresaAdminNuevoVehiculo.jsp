  ...
  <link rel="icon" type="image/x-icon" href="../Imagenes/favicon.ico">
    ...
    <body class="bg-gray-50 dark:bg-gray-900">
        ...
        <div class="min-h-full">
            ...
            <header class="bg-white shadow-sm">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nuevo Vehículo</h1>
                    <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                        ...
                        <x-placeholder>
                            <div class="mx-auto w-full bg-white p-6 shadow rounded-xl">
                                ...
                                <form id="miFormulario" class="needs-validation" novalidate
                                    action="/VistaVoluntia/vehiculo" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="vencimientoSeguroVehiculo"
                                                    id="vencimientoSeguroVehiculo" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorVencimientoSeguro">
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="fechaMatriculacionVehiculo"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Fecha de Matriculación
                                                </label>
                                                <input type="date" name="fechaMatriculacionVehiculo"
                                                    id="fechaMatriculacionVehiculo" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden"
                                                    id="errorFechaMatriculacion">Este campo es obligatorio.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="matriculaVehiculo" id="matriculaVehiculo"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="combustibleVehiculo"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Tipo de Combustible
                                                </label>
                                                <input type="text" name="combustibleVehiculo" id="combustibleVehiculo"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                    ...
                                    <div class="flex flex-wrap w-full">
                                        <div class="w-full">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="tipoVehiculo" id="tipoVehiculo"
                                    ...
                                    <div class="flex flex-wrap w-full">
                                        <div class="w-full">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="proximaITVehiculo" id="proximaITVehiculo"
                                                    required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorProximaITV">Este
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="indicativoVehiculo" id="indicativoVehiculo"
                                                    required placeholder="Indicativo"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorIndicativo">Este
                                                    campo es obligatorio.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="recursoVehiculo" id="recursoVehiculo"
                                                    placeholder="Recurso Vehículo"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap w-full">
                                        <div class="w-full">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="tipoCabinaVehiculo" id="tipoCabinaVehiculo"
                                    ...
                                    <div class="flex items-center space-x-6">
                                        <div class="shrink-0">
                                            <img id="imagenPreviewVehiculo" class="h-16 w-16 object-cover rounded-full"
                                        ...
                                        <label class="block">
                                            ...
                                            <input type="file" onchange="loadFile(event)" id="imagenVehiculo"
                                                name="imagenVehiculo" class="block w-full text-sm text-slate-500
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    document.getElementById('errorVencimientoSeguro').classList.add('hidden');
                    document.getElementById('errorFechaMatriculacion').classList.add('hidden');
                    document.getElementById('errorIndicativo').classList.add('hidden');
                    document.getElementById('errorProximaITV').classList.add('hidden');

                    let valid = true;

                    const vencimientoSeguroVehiculo = document.getElementById('vencimientoSeguroVehiculo');
                    if (!vencimientoSeguroVehiculo.value) {
                        valid = false;
                        document.getElementById('errorVencimientoSeguro').classList.remove('hidden');
                    }

                    const fechaMatriculacionVehiculo = document.getElementById('fechaMatriculacionVehiculo');
                    if (!fechaMatriculacionVehiculo.value) {
                        valid = false;
                        document.getElementById('errorFechaMatriculacion').classList.remove('hidden');
                    }

                    const indicativoVehiculo = document.getElementById('indicativoVehiculo');
                    if (!indicativoVehiculo.value) {
                        valid = false;
                        document.getElementById('errorIndicativo').classList.remove('hidden');
                    }

                    const proximaITVehiculo = document.getElementById('proximaITVehiculo');
                    if (!proximaITVehiculo.value) {
                        valid = false;
                        document.getElementById('errorProximaITV').classList.remove('hidden');
                    }
      ...
      `;
                    ...
                    setTimeout(() => {
                        container.remove();
                        window.location.href = "/VistaVoluntia/RolAdministradorEmpresa/EmpresaAdminNuevoVehiculo.jsp";
                    }, 3000);
                }
            });
        </script>
