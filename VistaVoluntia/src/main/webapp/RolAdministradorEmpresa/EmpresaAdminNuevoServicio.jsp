  ...
  <link rel="icon" type="image/x-icon" href="../Imagenes/favicon.ico">
    ...
    <body class="bg-gray-50 dark:bg-gray-900">
        ...
        <div class="min-h-full">
            ...
            <header class="bg-white shadow-sm">
                <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex justify-between items-center">
                    <h1 class="text-3xl font-bold tracking-tight text-gray-900">Nuevo Servicio</h1>
                    <a href="../RolAdministradorEmpresa/EmpresaAdminNuevaEmergencia.jsp"
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                <label for="numeracionServicio"
                                                    ...
                                                    Numeración del Servicio
                                                </label>
                                                <input type="text" name="numeracionServicio" id="numeracionServicio"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="tituloServicio" id="tituloServicio"
                                                    placeholder="Titulo Servicio" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorTitulo">Este campo
                                                    es obligatorio.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="fechaInicioServicio" id="fechaInicioServicio"
                                                    placeholder="Fecha Inicio" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorFechaInicio">Este
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="fechaFinServicio" id="fechaFinServicio"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="categoriaServicio" id="categoriaServicio"
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="date" name="fechaLimiteInscripcionServicio"
                                                    id="fechaLimiteInscripcionServicio" placeholder="Fecha Limite"
                                                    required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden"
                                                    id="errorFechaLimiteInscripcion">Este campo es obligatorio.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="time" name="horaBaseServicio" id="horaBaseServicio"
                                                    placeholder="Hora en Base" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        ...
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="time" name="horaSalidaServicio" id="horaSalidaServicio"
                                                    placeholder="Hora Salida" required
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                <p class="text-red-500 text-sm mt-1 hidden" id="errorHoraSalida">Este
                                                    campo es obligatorio.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="-mx-3 flex flex-wrap">
                                        <div class="w-full px-3 sm:w-1/2">
                                            <div class="mb-5">
                                                ...
                                                <input type="number" name="maximoAsistentesServicio"
                                                    id="maximoAsistentesServicio" placeholder="Maximo Asistentes"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap w-full">
                                        <div class="w-full">
                                            <div class="mb-5">
                                                ...
                                                <input type="text" name="descripcionServicio" id="descripcionServicio"
      ...
      `;
                    ...
                    setTimeout(() => {
                        container.remove();
                        window.location.href = "/VistaVoluntia/RolAdministradorEmpresa/EmpresaAdminNuevoServicio.jsp";
                    }, 3000);
                }
            });
        </script>
